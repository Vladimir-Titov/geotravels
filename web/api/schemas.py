...
class VisitsListRequest(BaseListRequest):
    ...
    marked_at: datetime | None = field(default=None)
    marked_at_ne: datetime | None = field(default=None)
    marked_at_lt: datetime | None = field(default=None)
    marked_at_le: datetime | None = field(default=None)
    marked_at_gt: datetime | None = field(default=None)
    marked_at_ge: datetime | None = field(default=None)
    marked_at_in: list[datetime] | None = field(default=None)
    marked_at_notin: list[datetime] | None = field(default=None)
